...
const CAMERA_SEEDS = [
  ...
  { id: 'dhaka-parliament-core', cityId: 'dhaka', poiIndex: 0, label: 'Parliament Core', offsetNorthM: 130, offsetEastM: 90, headingDeg: 180, fovDeg: 72, rangeM: 820, elevationM: 24 },
  { id: 'dhaka-hatirjheel-basin', cityId: 'dhaka', poiIndex: 2, label: 'Hatirjheel Basin', offsetNorthM: -120, offsetEastM: 70, headingDeg: 140, fovDeg: 70, rangeM: 760, elevationM: 22 },

  { id: 'hanoi-old-quarter-n', cityId: 'hanoi', poiIndex: 0, label: 'Old Quarter North', offsetNorthM: 140, offsetEastM: -80, headingDeg: 235, fovDeg: 69, rangeM: 700, elevationM: 22 },
  { id: 'hanoi-opera-corridor', cityId: 'hanoi', poiIndex: 1, label: 'Opera Corridor', offsetNorthM: 90, offsetEastM: 50, headingDeg: 30, fovDeg: 68, rangeM: 660, elevationM: 24 },

  { id: 'hcm-bitexco-south', cityId: 'ho_chi_minh', poiIndex: 0, label: 'Bitexco South', offsetNorthM: -170, offsetEastM: 90, headingDeg: 335, fovDeg: 72, rangeM: 820, elevationM: 30 },
  { id: 'hcm-benthanh-corridor', cityId: 'ho_chi_minh', poiIndex: 3, label: 'Ben Thanh Corridor', offsetNorthM: 110, offsetEastM: -110, headingDeg: 200, fovDeg: 66, rangeM: 700, elevationM: 22 },
...
function buildSummaryText() {
  ...
  return [
    ...
    health?.sourceKind
      ? `SRC ${String(health.sourceKind).toLowerCase() === 'demo' ? 'CLIP' : String(health.sourceKind).toUpperCase()}`
