...
import { requireLocalAccess } from './accessGate.js';
  ...
  try {
    ...
    const viewer = new Cesium.Viewer('cesiumContainer', {
      ...
      creditContainer: (() => {
        ...
        brandLink.className = 'rh-brand-credit';
        brandLink.href = 'https://rhinternationalsc.com/';
        brandLink.target = '_blank';
        brandLink.rel = 'noopener';
        brandLink.title = 'RHInternationalSC';
        brandLink.setAttribute('aria-label', 'Powered by RHInternationalSC');

        const brandLogo = document.createElement('img');
        brandLogo.src = 'https://rhinternationalsc.com/favicon.ico';
        brandLogo.alt = 'RHInternationalSC';
        brandLogo.width = 24;
        brandLogo.height = 24;
        ...
        brandText.textContent = 'Powered by RHInternationalSC';
...
void requireLocalAccess().then(() => init());
