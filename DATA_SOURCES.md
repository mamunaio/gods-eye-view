...
| **Dhaka Google Street View location imagery** | 16 major Dhaka traffic zones with coordinate-based location frames | Google Maps Platform Street View terms; requires a restricted server-side Google Maps key | Frames are requested for the selected camera coordinates; this is not live Dhaka authority CCTV and does not identify real people |
